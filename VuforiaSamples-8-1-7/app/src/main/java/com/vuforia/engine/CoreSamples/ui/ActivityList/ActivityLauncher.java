...
public class ActivityLauncher extends ListActivity
{
    ...
    private final String[] mActivities = { "Image Targets", "Model Targets",
            "Model Targets (trained)", "Ground Plane", "VuMark", "Cylinder Targets",
    ...
    public void onListItemClick(ListView l, View v, int position, long id)
    {
        ...
        switch (position)
        {
            ...
            case 2:
                intent.putExtra("ACTIVITY_TO_LAUNCH",
                        "app.ModelTargetsTrained.ModelTargetsTrained");
                intent.putExtra("ABOUT_TEXT", "ModelTargetsTrained/MDT_about.html");
                break;
            case 3:
                intent.putExtra("ACTIVITY_TO_LAUNCH",
